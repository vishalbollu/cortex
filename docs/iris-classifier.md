...
Here are the complete [Predictor docs](https://github.com/vishalbollu/cortex/tree/7c758e6fe0a55af88d3042719b481aa5d19ee4ae/docs/deployments/predictors/README.md).
...
You can skip dependencies that are [pre-installed](https://github.com/vishalbollu/cortex/tree/7c758e6fe0a55af88d3042719b481aa5d19ee4ae/docs/deployments/predictors/README.md) to speed up the deployment process. Note that `pickle` is part of the Python standard library so it doesn't need to be included.
...
Here are the complete [API configuration docs](deployments/api-configuration.md).

...
Note that some packages are pre-installed by default \(see "pre-installed packages" for your Predictor type in the [Sync API Predictor documentation](../deployments/syncapi/predictors.md) and [Batch API Predictor documentation](../deployments/batchapi/predictors.md)\).

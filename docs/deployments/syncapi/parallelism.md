...
The [TensorFlow Predictor](https://github.com/vishalbollu/cortex/tree/90f9a8405d1794d36ba9ec2d1b946a3e74d4de8f/docs/deployments/predictors.md#tensorflow-predictor) allows for the use of the following 2 fields in the `server_side_batching` configuration:

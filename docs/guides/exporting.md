...
For Inferentia-equipped instances, check the [Inferentia instructions](https://github.com/vishalbollu/cortex/tree/4a57092fdaff1f070059701af68beddeed4418af/docs/guides/inferentia.md#neuron).
...
You may export your trained model into an export directory, or use a checkpoint directory containing the export directory \(which is usually the case if you used `estimator.train_and_evaluate()`\). The folder may be zipped if you desire. For Inferentia-equipped instances, also check the [Inferentia instructions](https://github.com/vishalbollu/cortex/tree/4a57092fdaff1f070059701af68beddeed4418af/docs/guides/inferentia.md#neuron).
